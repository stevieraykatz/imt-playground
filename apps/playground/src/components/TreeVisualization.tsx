...
import type { IMTNode, IMTState } from '@stevieraykatz/imt-engine';
import { MAX_KEY, getNodeByKey, getRoot, getRawRoot, hashNode } from '@stevieraykatz/imt-engine';
...
export function TreeVisualization() {
  ...
  }, [recentlyInsertedIndex, recentlyUpdatedIndex, preview, clearPreview]);
